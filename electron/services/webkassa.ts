...
// Obfuscated Webkassa API Key
const getApiKey = () => {
  const p = ['V0st', 'NjUw', 'MDRE', 'QUQt', 'QzlF', 'RC00', 'Qzcx', 'LTk1', 'M0Qt', 'RUZG', 'M0Iy', 'NTE2', 'QkVG'];
  return Buffer.from(p.join(''), 'base64').toString('utf8');
};
const HARDCODED_API_KEY = getApiKey();
